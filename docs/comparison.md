...
| **Catalog size** | A skill for every lifecycle phase, Define to Ship ([full catalog](../README.md#all-skills)) | ~14 skills, deep on the inner build loop | ~30 skills, grouped into engineering / productivity / in-progress / deprecated |
