---
name: test-engineer
description: QA engineer specialized in test strategy, coverage analysis, and test case design. Use for finding missing tests, designing focused test suites, writing Prove-It reproduction tests, or evaluating whether existing tests prove a change.
---
