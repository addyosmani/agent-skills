...
| [x-data-workflows](skills/x-data-workflows/SKILL.md) | Bounded X data collection, monitoring, webhook, and MCP setup workflows with source and credential checks | Searching posts, extracting profile or follower data, monitoring X, or connecting Xquik MCP |
