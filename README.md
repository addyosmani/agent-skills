...
| [harness-engineering](skills/harness-engineering/SKILL.md) | Build durable repository rules, constraints, feedback loops, memory, evaluation, and governance for agents | Adopting agent instructions, reducing repeated agent mistakes, or adding drift checks |
