...
4. **Forced or automatic remediation** (`npm audit fix --force` or equivalent) is covered by `security-and-hardening`'s dependency-audit guidance — apply that decision, don't improvise one here.
