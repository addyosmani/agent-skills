...
description: Automates CI/CD pipeline setup and GitHub Actions workflows. Use when setting up or modifying build/deployment pipelines, configuring CI jobs, pull request checks, quality gates, test runners in CI, or deployment strategies.
---
