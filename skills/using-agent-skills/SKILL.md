...
description: Discovers and invokes agent skills. Use when starting a session, deciding which workflow applies, or discovering which skill owns the current task. This is the meta-skill that governs how all other skills are discovered and invoked.
---
...
Task arrives
    ...
    ├── Writing tests or test-first code? → test-driven-development
    ├── Running existing tests? ───────→ tests
